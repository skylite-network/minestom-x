...
public class AutoViewCommand extends Command {
    public AutoViewCommand() {
        ...
        addSyntax((sender, context) -> {
            ...
            player.sendMessage(Component.text("Auto-viewable set to " + autoView));
        ...
        addSyntax((sender, context) -> {
            ...
            player.sendMessage(Component.text("Auto-viewer set to " + autoView));
        ...
        addSyntax((sender, context) -> {
            ...
            player.sendMessage(Component.text(
                    "Viewable rule updated to see " + entities.size() + " players"));
        ...
        addSyntax((sender, context) -> {
            ...
            player.sendMessage(Component.text(
                    "Viewer rule updated to see " + entities.size() + " entities"));
        ...
        addSyntax((sender, context) -> {
            ...
            player.sendMessage(Component.text("Viewable rule removed"));
        ...
        addSyntax((sender, context) -> {
            ...
            player.sendMessage(Component.text("Viewer rule removed"));
        ...
        addSyntax((sender, context) -> {
            ...
            player.sendMessage(Component.text("Viewable rule updated"));
        ...
        addSyntax((sender, context) -> {
            ...
            player.sendMessage(Component.text("Viewer rule updated"));
